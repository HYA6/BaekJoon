...
int main()
{
    ...
    if (index == 0) answer = num + 3;
    else if (index == 1) answer = num + 2;
    else if (index == 2) answer = num + 1;

    if (answer % 3 == 0 && answer % 5 == 0) cout << "FizzBuzz";
    else if (answer % 3 == 0 && answer % 5 != 0) cout << "Fizz";
    else if (answer % 3 != 0 && answer % 5 == 0) cout << "Buzz";
    else cout << answer;
}